...
def get_samba_sales(start, end, url):
        ...
        if data:
            for key, value in data.items():
                ...
                if not doc_exists:
                    ...
                    tax_items_list = get_tax_settings(url)
                    
                    try:
                        posting_date, posting_time = get_posting_date(key, url)
                    ...
                    try:
                        ...
                        ticket_customer = get_sales_customer(key, url)
...
def get_sales_customer(ticket_id, url):
